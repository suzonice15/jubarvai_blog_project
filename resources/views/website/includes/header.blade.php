...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/adminfile')}}/bower_components/font-awesome/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/font_end/')}}/css/etalage.css" type="text/css" media="all" />
            ...
            <div class="row" style="padding-top: 14px;">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 padding-zero">
                    <div style="float: left">
                        <a href="{{URL::to('/')}}"><img src="{{url('/')}}/public/logo.png" style="float: right;padding-top: 5px;" alt="Solehinbd  shop" title="Solehinbd shop logo"></a>
                    </div>
                </div>
