...
@section('mainContent')
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            ...
            <form action="{{ url('admin/left/add/store') }}" class="form-horizontal" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-7 col-sm-12" style="margin-left: 10px">
                                <div class="form-group">
                                    ...
                                    <textarea name="add_title" id="add_title" class="form-control ckeditor"></textarea>
                                </div>
                                <div class="form-group">
