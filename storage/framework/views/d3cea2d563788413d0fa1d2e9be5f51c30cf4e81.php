...
<head>
    ...
    <meta property="og:image" content="<?=get_option('icon')?>">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart">
                      ...
                      <span class="sign"></span><span class="value"><?php echo '৳ ' . number_format($total, 2); ?></span>
                      </span>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav desktop-menu-responsive">
                                ...
                                $categories = DB::table('category')->select('category_id', 'category_title', 'category_name')->where('parent_id', 0)->where('status',1)->paginate(14);
...
<?php /**PATH /home/rsohojjp/public_html/resources/views/website/includes/header.blade.php ENDPATH**/ ?>