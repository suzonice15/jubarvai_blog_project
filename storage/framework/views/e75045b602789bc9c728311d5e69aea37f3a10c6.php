                    ...
                    <div class="box box-primary" style="border: 2px solid #ddd;">
                        ...
                        <div class="box-body" style="padding: 22px; ">
                            ...
                            <textarea class="form-control" rows="3" name="product_summary ckeditor"
                                      id="product_summary"> <?php echo e($product->product_summary); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="box box-primary" style="border: 2px solid #ddd;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rsohojjp/public_html/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>