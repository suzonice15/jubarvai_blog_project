                    ...
                    <div class="container">
                        <div class="breadcrumb-inner">
                            <ul class="list-inline list-unstyled">
                                ...
                                <li class='active'>অর্ডার ট্র্যাক করুন</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="cart-info">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="<?php echo e(url('/product')); ?>/<?php echo e($name); ?>"> <?= $item['name'] ?>
                                        </a>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="width:50%">
                                    <span class="bold totalamout"><b><?php echo '৳ ' . number_format($total, 2); ?>      </b></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="75%">
                                ...
                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?php echo '৳ ' . number_format($order->shipping_charge, 2); ?> </b></span>
                                </td>
                            </tr>
                            <tr>
                                <td style="75%">
                                ...
                                <td class="text-right" style="width:50%">
                                                    <span
                                                        class="bold totalamout"><b><?php echo '৳ ' . number_format($order->order_total, 2); ?> </b></span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rsohojjp/public_html/resources/views/website/track_order_page.blade.php ENDPATH**/ ?>