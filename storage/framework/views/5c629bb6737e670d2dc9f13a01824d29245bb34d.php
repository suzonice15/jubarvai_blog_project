                                                ...
                                                <div class="col-sm-6 col-xs-12" style="padding:0">
                                                    <h4 style="font-size:25px;margin: 15px 0 15px -18px;text-align:center;color:#0078B8;font-weight:900;text-align: left">
                                                        ...
                                                        <i class="fa fa-phone-square"
                                                           style="padding-left:20px;color:  #0078B8;"> </i> 01725-990884
                                                        <br>
                                                        <i class="fa fa-phone-square"
                                                           style="padding-left:20px;color: #0078B8;"> </i> 01725-901212
                                                        <br>

                                                        <i class="fa fa-phone-square"
                                                           style="padding-left:20px;color: #0078B8;"> </i> 01760-907607
                                                        <br>

                                                        <i class="fa fa-phone-square"
                                                           style="padding-left:20px;color: #0078B8;"> </i>
                                                        01312-333202<br>
