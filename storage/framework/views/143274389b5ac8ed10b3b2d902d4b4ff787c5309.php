        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href=" <?php echo e(url('admin/post/create')); ?>"><i class="fa fa-circle-o"></i>Add New Post </a>
                    </li>
                    <li><a href=" <?php echo e(url('admin/posts')); ?>"><i class="fa fa-circle-o"></i>All Posts List</a></li>
            ...
            <li   class="treeview ">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href=" <?php echo e(url('admin/right/add/create')); ?>"><i class="fa fa-circle-o"></i>Add New add </a></li>
                    <li><a href=" <?php echo e(url('admin/right/adds')); ?>"><i class="fa fa-circle-o"></i>Right adds</a></li>
            ...
            <li   class="treeview ">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href=" <?php echo e(url('admin/left/add/create')); ?>"><i class="fa fa-circle-o"></i>Add New Left add </a></li>
                    <li><a href=" <?php echo e(url('admin/left/adds')); ?>"><i class="fa fa-circle-o"></i>Left adds</a></li>
...
<?php /**PATH C:\Xampp\htdocs\jubarvai_blog_project\resources\views/layouts/includes/sidebar.blade.php ENDPATH**/ ?>