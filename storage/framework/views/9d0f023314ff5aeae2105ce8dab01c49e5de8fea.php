        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li class="first"><a href="<?php echo e(url('/')); ?>/customer/login" title="Contact us">Login/Registration</a></li>


                            <li><a href="<?php echo e(url('/')); ?>/track-your-order" title="About us">Track Order </a></li>
                            <li><a href="<?php echo e(url('/')); ?>/page/faq" title="faq">FAQ</a></li>
                             <li class="last"><a href="<?php echo e(url('/')); ?>/page/help-center" title="Where is my order?">Help Center</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li class="first"><a title="Your Account" href="<?php echo e(url('/')); ?>/page/about-us">About us</a></li>
                            <li><a title="Information" href="<?php echo e(url('/')); ?>/page/customer-service">Customer Service</a></li>
                            <li><a title="Addresses" href="<?php echo e(url('/')); ?>/page/company">Company</a></li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li class="first"><a href="<?php echo e(url('/')); ?>/page/shopping-guide" title="About us">Shopping Guide</a></li>
                            <li class=" last"><a href="<?php echo e(url('/')); ?>/page/contact-us" title="Suppliers">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/rsohojjp/public_html/resources/views/website/includes/footer.blade.php ENDPATH**/ ?>