                        ...
                        <div class="col-md-9 mobile_left_add">
                            ...
                            <div class="col-xs-12" style="text-align: center;">
                                ...
                                <div  data-tip="Copy to clipboard">
                                    ...
                                    <input  style="margin-top: 15px;margin-bottom: 5px;" id="<?php echo e($left->left_add_id); ?>" onclick="copyToClipboard('<?php echo e($left->left_add_id); ?>')" type="text" value="<?php echo e($left->promo_link); ?>">
                                </div>
...
<br/>
                    ...
                    <div class="col-sm-6 col-xs-6 col-md-4" style="float:left">
                        <a href="<?php echo e(url('/')); ?>/post/<?php echo e($sidebar->post_name); ?>">
...
overflow: hidden;width: 102%;">
                            <a href="<?php echo e(url('/')); ?>/post/<?php echo e($sidebar->post_name); ?>"><?php echo e($sidebar->post_title); ?></a></h4>
