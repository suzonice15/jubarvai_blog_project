        ...
        <div class="col-sm-offset-0 col-md-12">
          ...
          <input type="hidden" name="products[items][<?=$product_id?>][subtotal]" value="<?=$item['subtotal']?>"/>
                           ...
                           <table class="table table-striped table-bordered">
                               ...
                               <tbody>  <tr> <td> Sub Total </td> <td
                                       class="text-right"> ৳ <span
                                           id="subtotal_price_sujon"><?php echo $subtotal_price . '.00' ?></span> </td> </tr> <tr> <td> <span
                                           ...
                                           value="<?= $order->shipping_charge;?>"> </td> </tr> <tr> <td> <span
                                           ...
                                           value="<?php echo $order->discount_price; ?>"> </td> </tr> <tr> <td> <span
                                           ...
                                           value="<?php echo $order->advabced_price; ?>"> </td> </tr> <tr> <td> <span
                                           class="extra bold totalamout">Total</span> </td> <td
                                       class="text-right"> <span class="bold totalamout"><p> ৳ <span
                                                   id="total_cost"><?php echo $order->order_total; ?></span></p></span> <input
                                           type="hidden"
                                           name="order_total"
                                           id="order_total"
                                           value="<?php echo $order->order_total; ?>">
                               </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rsohojjp/public_html/resources/views/admin/order/edit.blade.php ENDPATH**/ ?>