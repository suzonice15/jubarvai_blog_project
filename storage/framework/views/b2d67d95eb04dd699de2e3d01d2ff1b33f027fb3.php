            ...
            <form  name="product" action="<?php echo e(url('admin/product/update')); ?>/<?php echo e($product->product_id); ?>" class="form-horizontal"
                            ...
                            <div style="margin-left: 31px;" class="col-sm-3">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="product_type" id="product_type"
                                        ...
                                        <option value="top">Home Top</option>
                                        <option value="bottom">Home Buttom</option>
                                    </select>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary" style="border: 2px solid #ddd;">
                                <div class="box-header" style="background-color: #bdbdbf;">
                                    ...
                                    <h3 class="box-title">Product Categories<span class="required">*</span></h3>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="box box-primary" style="border: 2px solid #ddd;height: 470px">
                                <div class="box-header" style="background-color: #bdbdbf;">
                ...
                <textarea  class="form-control ckeditor" rows="10" name="product_description"
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Product Update</button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\mylaravelecomerce\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>