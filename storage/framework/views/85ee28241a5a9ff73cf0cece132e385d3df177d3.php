...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/adminfile')); ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo e(url('/login_check')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<!-- iCheck -->
<script src="<?php echo e(asset('assets/adminfile')); ?>/plugins/iCheck/icheck.min.js"></script>
<script>
...
<?php /**PATH C:\Xampp\htdocs\jubarvai_blog_project\resources\views/login.blade.php ENDPATH**/ ?>