...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            <form action="<?php echo e(url('admin/user/update')); ?>/<?php echo e($user->admin_id); ?>" class="form-horizontal" method="post"
                  enctype="multipart/form-data">
                <?php echo csrf_field(); ?>


                    <div class="form-group "><label for="media_title">Name<span class="required">*</span></label>
                        <input type="text" required="" class="form-control" name="name" value="<?php echo e($user->name); ?>">
                ...
                <?php } ?>
					...
					<?php if($user->picture): ?>
					  <div class="form-group featured-image">
						...
						<img src="<?php echo e(URL::to('/public')); ?>/uploads/users/<?php echo e($user->picture); ?>">
                        <input type="hidden" class="form-control" name="old_picture" value="<?php echo e($user->picture); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\mylaravelecomerce\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>