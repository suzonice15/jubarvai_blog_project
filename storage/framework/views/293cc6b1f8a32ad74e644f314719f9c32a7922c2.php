...
" class="stars-container stars-0">★★★★★</span></div>
                                    ...
                                    <!-- /.stock-container -->
                                    <?php if($product->product_summary): ?>
                                                ...
                                                <div class="col-sm-6  col-xs-12 review-left" style="padding-left: 0;">
                                                    ...
                                                    <form class="form-vertical reviewform"  >
                                                        ...
                                                        <div class="form-group">
                                                            <input type="hidden" name="name" id="name" class="form-control field field-name" value="<?php echo e(Session::get('name')); ?>" placeholder="Name" style="width: 100% !important;">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="hidden" name="email" id="email" class="form-control field field-email" value="<?php echo e(Session::get('email')); ?>" placeholder="Email" style="width: 100% !important;">
                                                        </div>
                                                        <div class="form-group">
                                                            <textarea rows="3" name="comment" id="comment" class="form-control field field-comment" placeholder="Comments"></textarea>
                                                        </div>

                                                        <input type="hidden" name="product_id" id="product_review_id" value="<?php echo e($product->product_id); ?>">

                                                        <button style="background:#4267b2;color:#fff;border-radius:5px;margin-top:10px;margin-bottom:20px" type="button" id="reviewbtn" class="btn btn-new form-control">continue</button>
                                                    </form>
                                                </div>
                                                 <?php } else {  ?>
                                                 <a href="<?php echo e(URL::to('customer/login')); ?>" target="_blank" class="btn btn-success">To Write A Review Login First</a>
                                                <?php }?>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rsohojjp/public_html/resources/views/website/product.blade.php ENDPATH**/ ?>