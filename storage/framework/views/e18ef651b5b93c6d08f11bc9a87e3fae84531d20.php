                    ...
                    <div class="box-body" style="padding: 28px;">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="site_title" id="site_title"
                                   value="<?php echo e($setting_row->site_title); ?>">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <img width="50" src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($setting_row->logo); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <img width="50" src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($setting_row->icon); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\jubarvai_blog_project\resources\views/admin/setting/deafualt_setting.blade.php ENDPATH**/ ?>