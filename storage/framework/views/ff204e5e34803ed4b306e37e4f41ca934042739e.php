...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            ...
            <form name="product" action="<?php echo e(url('admin/post/update')); ?>/<?php echo e($product->post_id); ?>"
                ...
                <div class="box box-primary" style="border: 2px solid #ddd;">
                    ...
                    <div class="box-body" style="padding: 22px;">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control the_title"
                                           ...
                                           value="<?php echo e($product->post_title); ?>" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input required type="text" class="form-control the_name"
                                           ...
                                           value="<?php echo e($product->post_name); ?>" autocomplete="off">
                          ...
                          id="post_description"><?php echo e($product->post_description); ?></textarea>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xampp\htdocs\jubarvai_blog_project\resources\views/admin/post/edit.blade.php ENDPATH**/ ?>