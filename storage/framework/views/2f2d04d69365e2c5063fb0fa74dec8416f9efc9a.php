...
<head>
    ...
    <link href="<?php echo e(asset('assets/font_end')); ?>/plugin-frameworks/bootstrap.css" rel="stylesheet">

    <link href="<?php echo e(asset('assets/font_end')); ?>/fonts/ionicons.css" rel="stylesheet">


    <link href="<?php echo e(asset('assets/font_end')); ?>/common/styles.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/font_end')); ?>/sharetastic.css"/>
    <link href="https://www.topbettingsite24.com/wp-content/plugins/elementor/assets/css/frontend.min.css" rel="stylesheet">
    <script src="<?php echo e(asset('assets/font_end')); ?>/plugin-frameworks/jquery-3.2.1.min.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a  class='logo' href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($get_single_option->logo); ?>" alt="Logo">
                    </a>
                </div><!-- col-sm-4 -->
...
<?php /**PATH C:\Xampp\htdocs\jubarvai_blog_project\resources\views/website/includes/header.blade.php ENDPATH**/ ?>